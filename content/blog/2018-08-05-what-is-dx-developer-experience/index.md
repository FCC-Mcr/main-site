...
The error message not only states the error, but it also gives the developer the likely solution to the problem *per se*. Let’s compare this to an example of the error messages of Node v4.
